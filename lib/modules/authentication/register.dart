...
import 'package:madenati/modules/authentication/login.dart';
                            ...
                            onPressed: () {
                              if (formKey.currentState!
                               ...
                               if(nameControl.text == 'zaid'){
                                 defaultToast(massage: 'الحساب موجود بالفعل!', state: ToastStates.ERROR);
                                 Navigator.push(context, MaterialPageRoute(builder: (context)=> LoginPage()));
                               }else{
                                 defaultToast(massage: 'تم إنشاء الحساب بنجاح!', state: ToastStates.SUCCESS);
